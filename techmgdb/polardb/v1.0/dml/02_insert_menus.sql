-- v1.0 种子数据: 菜单树 + 角色菜单关联
-- 来源: backend/techmg-admin/src/main/resources/sql/init-menu.sql
-- type: 0=目录, 1=菜单
...
-- DEPT_ADMIN: 首页 + 技术管理 + 资产管理 + 生产管理 + 数智生态
INSERT INTO sys_role_menu (role_id, menu_id) VALUES
(2,1),
(2,10),(2,11),(2,12),(2,13),(2,15),(2,16),(2,17),(2,18),(2,19),(2,20),(2,21),(2,22),
(2,25),(2,26),(2,27),(2,28),(2,29),(2,30),
(2,35),(2,36),
(2,45),(2,46),(2,47),(2,48),(2,49);

-- DEPT_DBA: 首页 + 数据库管理 + 资产管理
INSERT INTO sys_role_menu (role_id, menu_id) VALUES
(3,1),
(3,10),(3,15),(3,16),(3,17),(3,18),(3,19),
(3,25),(3,26),(3,27),(3,28),(3,29),(3,30);

-- NORMAL_USER: 首页 + 技改任务管理 + 巡检查看
INSERT INTO sys_role_menu (role_id, menu_id) VALUES
(4,1),
(4,10),(4,11),(4,12),(4,13),
(4,15),(4,18);
